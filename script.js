...
class AppData{
    ...
    getBudget() {
        const monthDeposit = parseInt(this.moneyDeposit,10) * (parseInt(this.percentDeposit,10) / 100);
        this.budgetMonth = parseInt(this.budget, 10) + this.incomeMonth - appData.expensesMonth + parseInt(monthDeposit, 10);
    ...
    getInfoDeposit(){
        if (this.deposit) {
            if (this.passThrew === true){
                console.log("succes");
            } else {
                this.percentDeposit = selector.value;
            }
    ...
    depositHandler(){
        if(depositCheck.checked){
            ...
            this.deposit = true;
            selector.addEventListener('change', this.changePercent);
        } else  {
            ...
            depositAmount.value = "";
            selector.value = "";
            selector.removeEventListener('change', this.changePercent);
        }
    }
    addEventListeners() {
